...
class MessengerTopic extends Model
{
    ...
    {
        return $this->hasOne(User::class, 'id', 'sender_id')->withoutGlobalScopes(['created_by_id']);
    }

    public function receiver()
    {
        return $this->hasOne(User::class, 'id', 'receiver_id')->withoutGlobalScopes(['created_by_id']);
    }
